    ...
    def get_ewald_pot(self, coords1, coords2=None, charges2=None, zetas2=None):
        ...
        if charges2 is not None:
            ...
            if self.enable_octupole:
                ...
                temp   = contract('gxyz,ig->igxyz', temp3, sinGvR2)
                ewg12  = contract('igxyz,jg->ijxyz', temp, cosGvR2)
                temp   = contract('gxyz,ig->igxyz', temp3, cosGvR2)
                ewg12 -= contract('igxyz,jg->ijxyz', temp, sinGvR2)
                ewg12  = ewg12 / 3
                # qm pc - qm octu
                ewg03 = -ewg12 / 2
